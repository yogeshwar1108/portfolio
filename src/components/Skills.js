  ...
  return (
    <div className="skills">
      ...
      <div className=" grid-container ">
        {/* <div className="d-flex  flex-fill bd-highlight justify-content-around flex-wrap "> */}
      ...
      <section className="photos d-flex justify-content-center flex-wrap">
        ...
        <img id="img" src="https://moonshot.scaler.com/s/image/sl/ykeJuJwQ9K?scope=body" alt="c3" />
